  const APP_CONFIG = { showGuideBadge: false };
    ...
    const HEROES =[
...

      {
        ...
        spells:[
          { key: 'Trait', name: { fr: 'Purge', en: 'Purge' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_rehgar_purge.jpg', description: { fr: 'Utiliser sur un allié le rend Insensible, sur un ennemi le ralenti.', en: 'Targeting an ally grants Unstoppable, targeting an enemy slows them.' }, demoYoutubeId: 'assets/heroes/base_spells/rehgar/videos/rehgar_purge.mp4' },
          { key: 'A', name: { fr: 'Salve de guérison', en: 'Chain Heal' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_rehgar_chainheal.jpg', description: { fr: 'Soin qui rebondit sur les alliés autour de la cible.', en: 'Heal that bounces to allies near the target.' }, demoYoutubeId: 'assets/heroes/base_spells/rehgar/videos/rehgar_a.mp4' },
          { key: 'Z', name: { fr: 'Bouclier de foudre', en: 'Lightning Shield' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_rehgar_lightningshield.jpg', description: { fr: 'Place un bouclier de foudre qui inflige des dégâts et rend du mana.', en: 'Places a lightning shield that deals damage and restores mana.' }, demoYoutubeId: 'assets/heroes/base_spells/rehgar/videos/rehgar_z.mp4' },
          { key: 'E', name: { fr: 'Totem de liens terrestres', en: 'Earthbind Totem' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_rehgar_earthbindtotem.jpg', description: { fr: 'Pose un totem qui ralentit autour.', en: 'Spawns a totem that slows nearby enemies.' }, demoYoutubeId: 'assets/heroes/base_spells/rehgar/videos/rehgar_e.mp4' },
          { key: 'R1', name: { fr: 'Guérison ancestrale', en: 'Ancestral Healing' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_rehgar_ancestralhealing.jpg', description: { fr: 'Gros soin qui permet de sauver.', en: 'Massive burst heal that saves lives.' }, demoYoutubeId: 'assets/heroes/base_spells/rehgar/videos/rehgar_ancestral.mp4' },
          { key: 'R2', name: { fr: 'Furie sanguinaire', en: 'Bloodlust' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_rehgar_bloodlust.jpg', description: { fr: 'Augmente la vitesse de déplacement et d\'attaque, les attaques de base soignent.', en: 'Increases movement & attack speed, basic attacks heal.' }, demoYoutubeId: 'assets/heroes/base_spells/rehgar/videos/rehgar_bloodlust.mp4'},
          { key: 'W', name: { fr: 'Loup fantôme', en: 'Ghost Wolf' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_rehgar_ghostwolf.jpg', description: { fr: 'Augmente la vitesse de déplacement, la prochaine auto-attaque est plus forte.', en: 'Increases movement speed; next basic attack deals bonus damage.' }, demoYoutubeId: 'assets/heroes/base_spells/rehgar/videos/rehgar_mount.mp4' }
        ],
        tips:[
...

      {
        ...
        spells:[
          { key: 'Trait', name: { fr: 'Fidèle auditoire', en: 'Fortitude of the Faithful' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_deckard_protectors_of_cain.jpg', description: { fr: 'Lorsqu\'au moins un allié est proche de Deckard Cain, il obtient de l\'armure et ses temps de recharge se rechargent plus vite.', en: 'When at least one allied Hero is nearby, Deckard gains Armor and his Basic Abilities recharge faster.' }, demoYoutubeId: 'assets/heroes/base_spells/deckard/videos/deckard_trait.mp4' },
          { key: 'A', name: { fr: 'Potion de soin', en: 'Healing Potion' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_deckard_healing_potion.jpg', description: { fr: 'Lance une potion qui peut rester au sol et être consommée par les alliés pour se soigner.', en: 'Throws a potion that heals the first allied Hero to touch it.' }, demoYoutubeId: 'assets/heroes/base_spells/deckard/videos/deckard_a.mp4' },
          { key: 'Z', name: { fr: 'Cube horadrique', en: 'Horadric Cube' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_deckard_horadric_cube.jpg', description: { fr: 'Cube qui inflige des dégâts et ralentit en zone.', en: 'Throws a cube that deals damage and slows enemies in an area.' }, demoYoutubeId: 'assets/heroes/base_spells/deckard/videos/deckard_z.mp4' },
          { key: 'E', name: { fr: 'Parchemin de confinement', en: 'Scroll of Sealing' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_deckard_scroll_of_sealing.jpg', description: { fr: 'Triangle qui immobilise et inflige des dégâts.', en: 'Unfurls a scroll that roots and damages enemies inside.' }, demoYoutubeId: 'assets/heroes/base_spells/deckard/videos/deckard_e.mp4' },
          { key: 'R1', name: { fr: 'Restez un instant et écoutez', en: 'Stay Awhile and Listen' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_deckard_stay_awhile_and_listen.jpg', description: { fr: 'Canalise un cône devant lui qui endort les ennemis.', en: 'Channels a large cone that puts enemies to sleep.' }, demoYoutubeId: 'assets/heroes/base_spells/deckard/videos/deckard_r1.mp4' },
          { key: 'R2', name: { fr: 'Vous avez lu mon livre ?', en: 'Lorenado' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_deckard_lorenado.jpg', description: { fr: 'Crée une tornade qui repousse les ennemis sur son passage.', en: 'Creates a swirling tornado that knocks away enemies.' }, demoYoutubeId: 'assets/heroes/base_spells/deckard/videos/deckard_r2.mp4' }
        ],
        tips:[
...

      {
        ...
        spells:[
          { key: 'Trait', name: { fr: 'Don d\'espoir', en: 'Bestow Hope' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_auriel_bestowhope.jpg', description: { fr: 'Place une couronne sur un allié pour récupérer de l\'énergie selon ses dégâts.', en: 'Places a crown on an ally to gain Energy based on the damage they deal.' }, demoYoutubeId: 'assets/heroes/base_spells/auriel/videos/auriel_trait.mp4' },
          { key: 'A', name: { fr: 'Arc vertueux', en: 'Sacred Sweep' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_auriel_angelicsweep.jpg', description: { fr: 'Inflige des dégâts en arc de cercle. Dégâts augmentés au centre.', en: 'Deals damage in an arc. Damage is increased in the center.' }, demoYoutubeId: 'assets/heroes/base_spells/auriel/videos/auriel_a.mp4' },
          { key: 'Z', name: { fr: 'Rayon des Cieux', en: 'Ray of Heaven' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_auriel_rayofheaven.jpg', description: { fr: 'Consomme l\'énergie pour soigner en zone.', en: 'Consumes Energy to heal in an area.' }, demoYoutubeId: 'assets/heroes/base_spells/auriel/videos/auriel_z.mp4' },
          { key: 'E', name: { fr: 'Entrave', en: 'Detainment Strike' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_auriel_restrainingblow.jpg', description: { fr: 'Repousse un ennemi (étourdit si contre un mur).', en: 'Knocks an enemy back. If they collide with terrain, they are Stunned.' }, demoYoutubeId: 'assets/heroes/base_spells/auriel/videos/auriel_e.mp4' },
          { key: 'R1', name: { fr: 'Égide de cristal', en: 'Crystal Aegis' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_auriel_ribboncocoon.jpg', description: { fr: 'Place un allié en Stase puis inflige des dégâts autour.', en: 'Places an ally in Stasis, then deals damage around them.' }, demoYoutubeId: 'assets/heroes/base_spells/auriel/videos/auriel_r1.mp4' },
          { key: 'R2', name: { fr: 'Réssurection', en: 'Resurrect' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_auriel_resurrect.jpg', description: { fr: 'Ramène un allié mort à la vie. Peut être utiliser sur soi.', en: 'Brings a dead ally back to life. Can be used on yourself.' }, demoYoutubeId: 'assets/heroes/base_spells/auriel/videos/auriel_r2.mp4' },
...

      {
        ...
        spells:[
          ...
          { key: 'Z', name: { fr: 'Agent infectieux', en: 'Weighted Pustule' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_stukov_weightedpustule.jpg', description: { fr: 'Lance un projectile qui infecte et ralentit les ennemis.', en: 'Throws a projectile that infects and slows enemies.' }, demoYoutubeId: 'assets/heroes/base_spells/stukov/videos/stukov_z.mp4' },
          { key: 'E', name: { fr: 'Menace larvée', en: 'Lurking Arm' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_stukov_lurkingarm.jpg', description: { fr: 'Canalise une zone qui réduit au silence et inflige des dégâts.', en: 'Channels a zone that silences and damages enemies.' }, demoYoutubeId: 'assets/heroes/base_spells/stukov/videos/stukov_e.mp4' },
          { key: 'R1', name: { fr: 'Poussée éruptive', en: 'Massive Shove' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_stukov_massiveshove.jpg', description: { fr: 'Pousse un ennemi jusqu\'à ce qu\'il percute un obstacle.', en: 'Pushes an enemy until they hit terrain.' }, demoYoutubeId: 'assets/heroes/base_spells/stukov/videos/stukov_r1.mp4' },
          { key: 'R2', name: { fr: 'Frappe chaotique', en: 'Flailing Swipe' }, icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_stukov_flailingswipe.jpg', description: { fr: 'Balaye les ennemis en face de lui plusieurs fois.', en: 'Swipes enemies in front of him multiple times.' }, demoYoutubeId: 'assets/heroes/base_spells/stukov/videos/stukov_r2.mp4' }
        ],
        tips:[
