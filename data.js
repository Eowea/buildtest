...
const HEROES = [
    ...
    builds: [
      {
        enabled: true,
        order: 1,
        label: { fr: 'Build totem', en: 'Totem Build' },
      ...
      },
      {
        enabled: true,
        order: 2,
        label: { fr: 'Build loup', en: 'Wolf Build' },
        updatedAt: { fr: '6 Mai 2026', en: 'May 6, 2026' },
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Cœur farouche', en: 'Feral Heart' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_rehgar_ghostwolf.jpg',
            description: { fr: "Augmente la vitesse de déplacement de Loup fantôme et confère de l'armure.", en: 'Increases Ghost Wolf movement speed and grants armor.' },
            demoYoutubeId: null
          },
          {
            level: 4,
          ...
          {
            level: 7,
            name: { fr: 'Sang et tonnerre', en: 'Blood and Thunder' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_rehgar_ghostwolf.jpg',
            description: { fr: 'Les attaques faites en Loup fantôme réduisent les temps de recharge des capacités de base et rend du mana.', en: 'Attacks in Ghost Wolf form reduce basic ability cooldowns and restore mana.' },
            demoYoutubeId: null
          },
          {
            level: 10,
          ...
          {
            level: 13,
            name: { fr: 'Bouclier de terre', en: 'Earth Shield' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_rehgar_lightningshield.jpg',
            description: { fr: 'Applique un bouclier à son porteur en %pv.', en: 'Applies a shield to its target based on % max health.' },
            demoYoutubeId: null
          },
          {
            level: 16,
            name: { fr: 'Faim de loup', en: 'Hunger of the Wolf' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_rehgar_ghostwolf.jpg',
            description: { fr: 'Les attaques sous forme de Loup fantôme infligent des dégâts en %pv et rendent des points de vie', en: 'Attacks in Ghost Wolf form deal % health damage and restore health.' },
            demoYoutubeId: null
          },
          {
            level: 20,
  ...
  },
  {
    ...
    spells: [
      {
        key: 'Trait',
        name: { fr: 'Brume apaisante', en: 'Soothing Mist' },
        icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_brightwing_soothingmist.jpg',
        description: { fr: "À l'activation, supprime les effets incapacitants sur les alliés proches et Luisaile. Passivement, envoie des vagues de soins.", en: 'On activation, removes disabling effects from nearby allies and Brightwing. Passively sends out healing waves.' },
        demoYoutubeId: null
      },
      {
        key: 'A',
        name: { fr: 'Embrasement des Arcanes', en: 'Arcane Flare' },
        icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_brightwing_arcaneflare.jpg',
        description: { fr: 'Crache une zone au sol qui inflige des dégâts. Si la cible est au centre, déclenche un effet de soin de Brume Apaisante.', en: 'Spits a ground AoE that deals damage. If target is in the center, triggers a Soothing Mist heal.' },
        demoYoutubeId: null
      },
      {
        key: 'Z',
        ...
        description: { fr: 'Neutralise un ennemi.', en: 'Neutralizes an enemy hero.' },
        demoYoutubeId: null
      },
      {
        key: 'E',
        name: { fr: 'Poudre de perlimpinpin', en: 'Pixie Dust' },
        icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_brightwing_pixiedust.jpg',
        description: { fr: "Applique de l'armure anti-sort et augmente la vitesse de déplacement.", en: 'Applies spell armor and increases movement speed.' },
        demoYoutubeId: null
      },
      {
        key: 'R1',
        name: { fr: 'Papillonnage', en: 'Blink Heal' },
        icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_brightwing_blinkheal.jpg',
        description: { fr: 'Se téléporte vers un allié et le soigne.', en: 'Teleports to an ally and heals them.' },
        demoYoutubeId: null
      },
      {
        key: 'R2',
        name: { fr: "Vent d'émeraude", en: 'Emerald Wind' },
        icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_brightwing_emeraldwind.jpg',
        description: { fr: 'Créer une vague qui repousse et inflige des dégâts aux ennemis.', en: 'Creates an expanding wave that damages and pushes enemies away.' },
        demoYoutubeId: null
      },
      {
        key: 'W',
        name: { fr: 'Déphasage', en: 'Phase Shift' },
        icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_brightwing_hypershift.jpg',
        description: { fr: 'Se téléporte sur un allié et le soigne en %pv.', en: 'Teleports to an ally and heals them based on % max health.' },
        demoYoutubeId: null
      }
    ],
    tips: [
    ...
    builds: [
      {
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Hyperphase', en: 'Hyper Shift' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_brightwing_hypershift.jpg',
            description: { fr: 'Augmente le montant de soins de Déphasage et son temps de recharge est réduit pour chaque serviteur tué.', en: 'Increases Phase Shift healing amount and its cooldown is reduced for each minion killed.' },
            demoYoutubeId: null
          },
          {
            level: 4,
            name: { fr: 'Crachat magique', en: 'Magic Spit' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_talent_autoattack_cooldown.jpg',
            description: { fr: "Augmente la portée d'auto-attaque et ses auto-attaques réduisent le temps de recharge de Brume Apaisante.", en: 'Increases basic attack range and basic attacks reduce Soothing Mist cooldown.' },
            demoYoutubeId: null
          },
          {
            level: 7,
            name: { fr: 'Je te vois !', en: 'Peekaboo!' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_brightwing_hypershift.jpg',
            description: { fr: 'Déphasage confère un bouclier à Luisaile et sa cible, puis révèle la zone autour.', en: 'Phase Shift grants a shield to Brightwing and her target, then reveals the surrounding area.' },
            demoYoutubeId: null
          },
          {
            level: 10,
          ...
          {
            level: 13,
            name: { fr: 'Superlimpinpin', en: 'Pixie Power' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_brightwing_pixiedust_b.jpg',
            description: { fr: "Réduit le temps de recharge de Poudre de perlimpinpin et augmente l'armure anti-sort.", en: 'Reduces Pixie Dust cooldown and increases spell armor.' },
            demoYoutubeId: null
          },
          {
            level: 16,
            name: { fr: 'Bestiolifier', en: 'Critterize' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_brightwing_polymorph.jpg',
            description: { fr: "Métamorphose réduit l'armure.", en: 'Polymorph reduces armor.' },
            demoYoutubeId: null
          },
          {
            level: 20,
            name: { fr: 'Dragon express', en: 'Speedy Dragon' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_brightwing_hypershift.jpg',
            description: { fr: 'Déphasage se canalise plus rapidement et augmente passivement la vitesse de déplacement.', en: 'Phase Shift channels faster and passively increases movement speed.' },
            demoYoutubeId: null
          }
        ]
      },
      {
        ...
        talents: [
          ...
          {
            level: 7,
            name: { fr: 'Brume opportune', en: 'Critical Mist' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_brightwing_soothingmist.jpg',
            description: { fr: "À l'activation de Brume apaisante, la purge est plus efficace.", en: 'Activating Soothing Mist removes disabling effects more effectively.' },
            demoYoutubeId: null,
            alternatives: [
              {
                name: { fr: 'Je te vois !', en: 'Peekaboo!' },
  ...
  },
  {
    ...
    builds: [
        ...
        talents: [
          {
            ...
            description: { fr: 'Augmente le ralentissement du Cube horadrique.', en: 'Increases Horadric Cube slow.' },
            demoYoutubeId: null
          },
          {
            level: 4,
            name: { fr: 'Potion de bouclier', en: 'Shielding Potion' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_deckard_healing_potion.jpg',
            description: { fr: 'Les potions confèrent un bouclier.', en: 'Potions grant a shield upon healing.' },
            demoYoutubeId: null
          },
          {
            level: 7,
            name: { fr: 'Cube de Kanai', en: "Kanai's Cube" },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_deckard_kanais_cube.jpg',
            description: { fr: 'Le Cube horadrique réduit les dégâts infligés par les ennemis.', en: 'Horadric Cube reduces damage dealt by enemies.' },
            demoYoutubeId: null
          },
          {
            level: 10,
          ...
          {
            level: 13,
            name: { fr: 'Bénédiction antique', en: 'Ancient Blessings' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_deckard_angelic_conduit.jpg',
            description: { fr: 'Renforce les attaques de base de tous les alliés à proximité et les soigne.', en: "Empowers nearby allies' basic attacks and heals them." },
            demoYoutubeId: null
          },
          {
            level: 16,
            name: { fr: 'Bâton horadrique', en: 'Horadric Staff' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_deckard_horadric_staff.jpg',
            description: { fr: 'Les attaques de base étourdissent.', en: 'Basic attacks stun.' },
            demoYoutubeId: null
          },
          {
            level: 20,
            name: { fr: 'Respectez vos aînés', en: 'Respect the Elderly' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_deckard_stay_awhile_and_listen.jpg',
            description: { fr: 'Restez un instant et écoutez rend les ennemis Silence et Aveugle au réveil.', en: 'Stay Awhile and listen silences and blinds enemies upon waking up.' },
            demoYoutubeId: null
          }
        ]
      },
      {
        enabled: true,
        order: 2,
        label: { fr: 'Build ARAM', en: 'ARAM Build' },
        updatedAt: { fr: '6 Mai 2026', en: 'May 6, 2026' },
        ...
        talents: [
          {
            level: 1,
            name: { fr: "Parchemin d'identification", en: 'Scroll of Identify' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_deckard_scroll_of_sealing.jpg',
            description: { fr: "Quête: augmente les dégâts de Parchemin de confinement et réduit l'armure une fois les paliers atteints.", en: "Quest: increases Scroll of Sealing's damage and reduces Armor once the rewards are unlocked." },
            demoYoutubeId: null
          },
          {
            level: 4,
            ...
            description: { fr: 'Le proche Cube horadrique génère des petites potions de soin.', en: 'The next Horadric Cube spawns Lesser Healing Potions.' },
            demoYoutubeId: null
          },
          {
            level: 7,
            name: { fr: 'Cube de Kanai', en: "Kanai's Cube" },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_deckard_kanais_cube.jpg',
            description: { fr: 'Le Cube horadrique réduit les dégâts infligés par les ennemis.', en: 'Horadric Cube reduces the damage dealt by enemies.' },
            demoYoutubeId: null
          },
          {
            level: 10,
            name: { fr: 'Restez un instant et écoutez', en: 'Stay Awhile and Listen' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_deckard_stay_awhile_and_listen.jpg',
            description: { fr: 'Endort les ennemis en face.', en: 'Puts enemies in front of Deckard to Sleep.' },
            demoYoutubeId: null
          },
          {
            level: 13,
          ...
          {
            level: 16,
            name: { fr: 'Parchemin de pétrification', en: 'Scroll of Stone Curse' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_deckard_scroll_of_sealing.jpg',
            description: { fr: 'Parchemin de confinement inflige plus de dégâts lorsque plusieurs héros sont touchés.', en: 'Scroll of Sealing deals much more damage when it hits multiple Heroes.' },
            demoYoutubeId: null
          },
          {
            level: 20,
            name: { fr: 'Gemmes sans défaut', en: 'Perfect Gems' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_deckard_perfect_gems.jpg',
            description: { fr: 'Réduit le temps de recharge des gemmes et de Cube horadique.', en: 'Reduces the cooldown of Gems and Horadric Cube.' },
            demoYoutubeId: null
          }
        ]
      }
  ...
  },
  {
    ...
    spells: [
      {
        key: 'Trait',
        name: { fr: 'Reine-dragon', en: 'Dragonqueen' },
        icon: '',
        description: { fr: 'Se transforme en dragon surpuissant.', en: 'Transforms into a massively powerful dragon.' },
        demoYoutubeId: ''
      },
      {
        key: 'A',
        name: { fr: 'Don de vie', en: 'Gift of Life' },
        icon: '',
        description: { fr: 'Sacrifie de la vie pour soigner un allié.', en: 'Sacrifices health to heal an ally.' },
        demoYoutubeId: ''
      },
      {
        key: 'Z',
        ...
        icon: '',
        description: { fr: 'Pose une zone qui soigne après un délai.', en: 'Plants an AoE that heals after a delay.' },
        demoYoutubeId: ''
      },
      {
        key: 'E',
        name: { fr: 'Rafale de flammes', en: 'Flame Buffet' },
        icon: '',
        description: { fr: 'Enflamme un ennemi. Toucher un ennemi enflammé le ralentit.', en: 'Ignites an enemy. Hitting an ignited enemy slows them.' },
        demoYoutubeId: ''
      },
      {
        key: 'R1',
        name: { fr: 'Lieuse-de-vie', en: 'Life-Binder' },
        icon: '',
        description: { fr: 'Égalise les pourcentages de vie entre elle et un allié.', en: 'Equalizes health percentages between her and an ally.' },
        demoYoutubeId: ''
      },
      {
        key: 'R2',
        name: { fr: 'Flammes purificatrices', en: 'Cleansing Flame' },
        icon: '',
        description: { fr: "S'envole et bombarde la zone.", en: 'Takes to the skies and bombs the area.' },
        demoYoutubeId: ''
      }
    ],
    tips: [
    ...
    builds: [
      {
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Cercle de vie', en: 'Circle of Life' },
            icon: '',
            description: { fr: 'Améliore le soin de zone.', en: 'Improves AoE heal.' },
            demoYoutubeId: null
          }
        ]
      },
      {
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Flammes de fureur', en: 'Flames of Fury' },
            icon: '',
            description: { fr: 'Réduit le CD du Trait.', en: 'Reduces Trait CD.' },
            demoYoutubeId: null
          }
        ]
      }
  ...
  },
  {
    ...
    spells: [
      {
        key: 'Trait',
        name: { fr: 'Pie-grièche', en: 'Shrike' },
        icon: '',
        description: { fr: 'Empoisonne les ennemis avec ses attaques.', en: 'Poisons enemies with basic attacks.' },
        demoYoutubeId: ''
      },
      {
        key: 'A',
        name: { fr: 'Fléchette de soins', en: 'Healing Dart' },
        icon: '',
        description: { fr: 'Tire un soin en ligne droite.', en: 'Fires a healing dart in a line.' },
        demoYoutubeId: ''
      },
      {
        key: 'Z',
        name: { fr: 'Grenade biotique', en: 'Biotic Grenade' },
        icon: '',
        description: { fr: 'Soigne les alliés et empêche les ennemis de se soigner.', en: 'Heals allies and prevents enemy healing.' },
        demoYoutubeId: ''
      },
      {
        key: 'E',
        name: { fr: 'Fléchette hypodermique', en: 'Sleep Dart' },
        icon: '',
        description: { fr: 'Endort le premier ennemi touché.', en: 'Puts the first enemy hit to sleep.' },
        demoYoutubeId: ''
      },
      {
        key: 'R1',
        name: { fr: 'Nanoboost', en: 'Nano Boost' },
        icon: '',
        description: { fr: "Booste massivement la magie d'un allié.", en: "Massively boosts an ally's spell power and cooldowns." },
        demoYoutubeId: ''
      },
      {
        key: 'R2',
        name: { fr: "Œil d'Horus", en: 'Eye of Horus' },
        icon: '',
        description: { fr: 'Prend position pour tirer à portée illimitée.', en: 'Sets up to fire unlimited range rounds.' },
        demoYoutubeId: ''
      }
    ],
    tips: [
    ...
    builds: [
      {
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Grenade de soins', en: 'Healing Grenade' },
            icon: '',
            description: { fr: 'Améliore la grenade.', en: 'Improves the grenade.' },
            demoYoutubeId: null
          }
        ]
      },
      {
        enabled: true,
        order: 2,
        label: { fr: 'Sleep / Trait', en: 'Sleep / Trait' },
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Vampirique', en: 'Vampiric' },
            icon: '',
            description: { fr: 'Soigne avec le trait.', en: 'Heals with the trait.' },
            demoYoutubeId: null
          }
        ]
      }
  ...
  },
  {
    ...
    spells: [
      {
        key: 'Trait',
        name: { fr: 'Dogme', en: 'Dogma' },
        icon: '',
        description: { fr: 'Le Trait se choisit au niveau 1 (Dégâts, Soins ou Mana).', en: 'Trait is chosen at level 1 (Damage, Heals or Mana).' },
        demoYoutubeId: ''
      },
      {
        key: 'A',
        name: { fr: 'Frappe éclair', en: 'Radiant Dash' },
        icon: '',
        description: { fr: 'Bondit vers un allié ou un ennemi.', en: 'Dashes to an ally or enemy.' },
        demoYoutubeId: ''
      },
      {
        key: 'Z',
        name: { fr: 'Souffle divin', en: 'Breath of Heaven' },
        icon: '',
        description: { fr: 'Soigne les alliés proches et donne de la vitesse.', en: 'Heals nearby allies and grants movement speed.' },
        demoYoutubeId: ''
      },
      {
        key: 'E',
        name: { fr: 'Frappe mortelle', en: 'Deadly Reach' },
        icon: '',
        description: { fr: "Augmente la vitesse d'attaque et la portée.", en: 'Increases attack speed and range.' },
        demoYoutubeId: ''
      },
      {
        key: 'R1',
        name: { fr: 'Paume divine', en: 'Divine Palm' },
        icon: '',
        description: { fr: 'Sauve un allié de la mort avec un gros soin.', en: 'Saves an ally from death with a massive heal.' },
        demoYoutubeId: ''
      },
      {
        key: 'R2',
        name: { fr: 'Les Sept frappes', en: 'Seven-Sided Strike' },
        icon: '',
        description: { fr: 'Inflige des dégâts lourds en pourcentage de vie dans une zone.', en: 'Deals heavy percentage health damage in an area.' },
        demoYoutubeId: ''
      }
    ],
    tips: [
    ...
    builds: [
      {
        enabled: true,
        order: 1,
        label: { fr: 'Poings de fer', en: 'Iron Fists' },
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Poings de fer', en: 'Iron Fists' },
            icon: '',
            description: { fr: 'Bonus de dégâts sur la 3ème attaque.', en: 'Bonus damage on 3rd attack.' },
            demoYoutubeId: null
          }
        ]
      },
      {
        enabled: true,
        order: 2,
        label: { fr: 'Transcendance', en: 'Transcendence' },
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Transcendance', en: 'Transcendence' },
            icon: '',
            description: { fr: 'Soin sur la 3ème attaque.', en: 'Heal on 3rd attack.' },
            demoYoutubeId: null
          }
        ]
      }
  ...
  },
  {
    ...
    spells: [
      {
        key: 'Trait',
        name: { fr: 'Pied véloce', en: 'Fast Feet' },
        icon: '',
        description: { fr: 'Gagne en vitesse de déplacement quand elle prend des dégâts.', en: 'Gains movement speed when taking damage.' },
        demoYoutubeId: ''
      },
      {
        key: 'A',
        name: { fr: 'Cruche des mille tasses', en: 'Healing Brew' },
        icon: '',
        description: { fr: "Soigne automatiquement l'allié le plus blessé à portée.", en: 'Automatically heals the most injured ally in range.' },
        demoYoutubeId: ''
      },
      {
        key: 'Z',
        name: { fr: 'Serpent nuageux', en: 'Cloud Serpent' },
        icon: '',
        description: { fr: 'Place un serpent sur un allié qui attaque et soigne.', en: 'Places a serpent on an ally that attacks and heals.' },
        demoYoutubeId: ''
      },
      {
        key: 'E',
        name: { fr: 'Vent aveuglant', en: 'Blinding Wind' },
        icon: '',
        description: { fr: 'Aveugle automatiquement les cibles proches.', en: 'Automatically blinds nearby targets.' },
        demoYoutubeId: ''
      },
      {
        key: 'R1',
        name: { fr: 'Cruche des 1 000 tasses', en: 'Jug of 1,000 Cups' },
        icon: '',
        description: { fr: "Canalise d'énormes soins continus en zone.", en: 'Channels massive continuous AoE heals.' },
        demoYoutubeId: ''
      },
      {
        key: 'R2',
        name: { fr: "Dragon d'eau", en: 'Water Dragon' },
        icon: '',
        description: { fr: 'Invoque un dragon qui ralentit et blesse un ennemi.', en: 'Summons a dragon that slows and damages an enemy.' },
        demoYoutubeId: ''
      }
    ],
    tips: [
    ...
    builds: [
      {
        enabled: true,
        order: 1,
        label: { fr: 'Build Aveuglement', en: 'Blind Build' },
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Vent persistant', en: 'Gale Force' },
            icon: '',
            description: { fr: 'Améliore E.', en: 'Improves E.' },
            demoYoutubeId: null
          }
        ]
      },
      {
        enabled: true,
        order: 2,
        label: { fr: 'Build Serpent', en: 'Serpent Build' },
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Ami des serpents', en: 'Wind Serpent' },
            icon: '',
            description: { fr: 'Améliore W.', en: 'Improves W.' },
            demoYoutubeId: null
          }
        ]
      }
  ...
  },
  {
    ...
    spells: [
      {
        key: 'Trait',
        name: { fr: 'Réacteur Caduceus', en: 'Caduceus Reactor' },
        icon: '',
        description: { fr: "Régénère de la vie quand le rayon de soins n'est pas utilisé.", en: 'Regenerates health when healing beam is not active.' },
        demoYoutubeId: ''
      },
      {
        key: 'A',
        name: { fr: 'Rayon de soins', en: 'Healing Beam' },
        icon: '',
        description: { fr: 'Canalise un soin continu sur un allié.', en: 'Channels a continuous heal on an ally.' },
        demoYoutubeId: ''
      },
      {
        key: 'Z',
        name: { fr: 'Protection', en: 'Safeguard' },
        icon: '',
        description: { fr: "Donne de l'armure à un allié.", en: 'Grants armor to an ally.' },
        demoYoutubeId: ''
      },
      {
        key: 'E',
        name: { fr: 'Grenade de déplacement', en: 'Displacement Grenade' },
        icon: '',
        description: { fr: 'Tire une grenade qui explose et repousse les ennemis.', en: 'Fires a grenade that explodes and knocks enemies back.' },
        demoYoutubeId: ''
      },
      {
        key: 'R1',
        name: { fr: 'Drone de transport', en: 'Medivac Dropship' },
        icon: '',
        description: { fr: "Transporte l'équipe n'importe où sur la carte.", en: 'Transports the team anywhere on the map.' },
        demoYoutubeId: ''
      },
      {
        key: 'R2',
        name: { fr: 'Rayon stimulant', en: 'Stim Drone' },
        icon: '',
        description: { fr: "Augmente massivement la vitesse d'un allié.", en: "Massively increases an ally's speed." },
        demoYoutubeId: ''
      }
    ],
    tips: [
    ...
    builds: [
      {
        enabled: true,
        order: 1,
        label: { fr: 'Build Protection', en: 'Safeguard Build' },
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Protection longue', en: 'Prolonged Safeguard' },
            icon: '',
            description: { fr: 'Améliore W.', en: 'Improves W.' },
            demoYoutubeId: null
          }
      ...
      },
      {
        enabled: true,
        order: 2,
        label: { fr: 'Build Grenade', en: 'Grenade Build' },
  ...
  },
  {
    ...
    gameplay: {
      ...
      en: 'Malfurion applies HoTs on allies, then hits enemies with Moonfire to trigger instant burst heals.'
    },
    guideVideo: null,
    spells: [
      {
    ...
    builds: [
      {
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Éclat céleste', en: 'Celestial Alignment' },
            icon: '',
            description: { fr: 'Améliore W.', en: 'Improves W.' },
            demoYoutubeId: null
          }
      ...
      },
      {
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Sarments profonds', en: 'Deep Roots' },
            icon: '',
            description: { fr: 'Améliore E.', en: 'Improves E.' },
            demoYoutubeId: null
          }
  ...
  },
  {
    ...
    builds: [
        ...
        talents: [
          {
            ...
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_stukov_bio-killswitch.jpg',
            description: { fr: "Actif : Propage Agent infectieux autour de Stukov à ses ennemis et annule le temps de recharge d'Éruption éruptive. Passif : Quand les points de vie de Stukov sont bas, le temps de recharge d'Éruption éruptive est plus rapide.", en: "Active: Spreads Weighted Pustule to nearby enemies and resets Bio-Kill Switch's cooldown. Passive: When Stukov's Health is low, Bio-Kill Switch recharges faster." },
            demoYoutubeId: null
          },
          {
            level: 4,
            ...
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_stukov_bio-killswitch.jpg',
            description: { fr: "Augmente les points de vie rendus par Éruption virale si un certain nombre d'alliés sont sous Virus régénérateur.", en: 'Increases the healing provided by Bio-Kill Switch if a certain number of allies are affected by Healing Pathogen.' },
            demoYoutubeId: null
          },
          {
            level: 7,
            ...
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_stukov_lurkingarm.jpg',
            description: { fr: "Augmente la zone d'effet de Menace larvée sur la durée, mais sa durée devient limité.", en: 'Increases the area of effect of Lurking Arm over time, but its duration becomes limited.' },
            demoYoutubeId: null
          },
          {
            level: 10,
          ...
          },
          {
            ...
            description: { fr: 'Exploser les Agents infectieux sur les ennemis dans Menace larvée les immobilise.', en: 'Detonating Weighted Pustules on enemies inside Lurking Arm Roots them.' },
            demoYoutubeId: null
          },
          {
            level: 16,
            ...
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_stukov_healingpathogen.jpg',
            description: { fr: "Virus régénérateur rend des points de vie supplémentaires en cas d'étourdissement ou d'immobilisation", en: 'Healing Pathogen heals for an additional amount when the target is Stunned or Rooted.' },
            demoYoutubeId: null
          },
          {
            level: 20,
            ...
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_stukov_massiveshove.jpg',
            description: { fr: 'Poussée éruptive ralentit lorsque la cible percute un obstacle et peut voir son temps de recharge réduit.', en: 'Massive Shove slows the target when they hit terrain, and can have its cooldown reduced.' },
            demoYoutubeId: null,
            alternatives: [
              {
                name: { fr: 'Chaos maîtrisé', en: 'Controlled Chaos' },
                icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_stukov_flailingswipe.jpg',
                description: { fr: 'Frappes chaotiques touche une seule fois mais possède plusieurs charges.', en: 'Flailing Swipe hits only once but has multiple charges.' },
                demoYoutubeId: null
              }
            ]
          }
      ...
      },
      {
        enabled: false,
        order: 2,
        label: { fr: 'Build Pustule', en: 'Pustule Build' },
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Éclatement', en: 'Fetid Touch' },
            icon: '',
            description: { fr: 'Améliore W.', en: 'Improves W.' },
            demoYoutubeId: null
          }
    ...
    spells: [
      {
        ...
        description: { fr: "Actif: Révèle et réduit l'armure d'un ennemi. Passif: les attaques de base de Tyrande lui rendent des points de vie, montant augmenté si la cible est marquée.", en: "Active: Reveals an enemy and reduces their Armor. Passive: Tyrande's Basic Attacks heal her, with increased healing against marked targets." },
        demoYoutubeId: ''
      },
      {
        key: 'A',
        name: { fr: "Lumière d'Élune", en: 'Light of Elune' },
        icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_tyrande_lightofelune.jpg',
        description: { fr: 'Soigne un allié. Les attaques de base réduisent le CD.', en: 'Heals an ally. Basic Attacks reduce its cooldown.' },
        demoYoutubeId: ''
      },
      {
        key: 'Z',
        name: { fr: 'Sentinelle', en: 'Sentinel' },
        icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_tyrande_sentinel.jpg',
        description: { fr: 'Chouette qui scout et inflige des dégâts globaux.', en: 'Sends an Owl that scouts and deals global damage.' },
        demoYoutubeId: ''
      },
      {
        key: 'E',
        name: { fr: 'Éclat de lune', en: 'Lunar Flare' },
        icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_tyrande_lunarflare.jpg',
        description: { fr: 'Étourdit les ennemis dans une petite zone.', en: 'Stuns enemies in a small area.' },
        demoYoutubeId: ''
      },
      {
        key: 'R1',
        name: { fr: "Éclipse d'Élune", en: 'Shadowstalk' },
        icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_tyrande_shadowstalk.jpg',
        description: { fr: 'Camoufle et soigne tous les alliés.', en: 'Stealths and heals all allied Heroes.' },
        demoYoutubeId: ''
      },
      {
        key: 'R2',
        name: { fr: 'Météores', en: 'Starfall' },
        icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_tyrande_starfall.jpg',
        description: { fr: 'Dégâts de zone et ralentissement.', en: 'Deals area damage and Slows enemies.' },
        demoYoutubeId: ''
      }
    ],
    tips: [
    ...
    builds: [
      {
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Flèche lunaires', en: 'Moonlit Arrows' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_tyrande_lightofelune.jpg',
            description: { fr: "Les attaques de base réduisent davantage le temps de recharge du Lumière d'Élune.", en: "Basic Attacks further reduce Light of Elune's cooldown." },
            demoYoutubeId: null
          },
          {
            level: 4,
            name: { fr: "Élue d'Élune", en: "Elune's Chosen" },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_talent_autoattack_heal.jpg',
            description: { fr: 'Applique une marque sur un allié, les attaques de base de Tyrande le soigne.', en: "Activate to make Tyrande's Basic Attacks heal the targeted allied Hero for 175% of the damage dealt." },
            demoYoutubeId: null
          },
          {
            level: 7,
            name: { fr: 'Fureur de la chasseresse', en: "Huntress' Fury" },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_tyrande_huntersmark.jpg',
            description: { fr: 'Les attaques de base de Tyrande sur une cible sous Marque du chasseur rebondissent sur les héros adverses proches. Passif: Augmente la durée et la portée de Marque du chasseur.', en: "Tyrande's Basic Attacks against targets with Hunter's Mark bounce to nearby enemy Heroes. Passive: increases Hunter's Mark duration and cast range." },
            demoYoutubeId: null
          },
          {
            level: 10,
            name: { fr: 'Météores', en: 'Starfall' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_tyrande_starfall.jpg',
            description: { fr: 'Zone de dégâts qui ralentit.', en: 'Creates a damaging area that Slows enemies.' },
            demoYoutubeId: null
          },
          {
            level: 13,
            name: { fr: 'Marque du forestier', en: "Ranger's Mark" },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_tyrande_huntersmark.jpg',
            description: { fr: "Les attaques de base réduisent le temps de recharge de Marque du chasseur. Les attaques de base portées à une cible marquée réduisent le temps de recharge d'Éclat d'Élune.", en: "Basic Attacks reduce Hunter's Mark's cooldown. Basic Attacks against marked targets reduce Lunar Flare's cooldown." },
            demoYoutubeId: null
          },
          {
            level: 16,
            name: { fr: 'Harmonisation céleste', en: 'Celestial Attunement' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_tyrande_lightofelune.jpg',
            description: { fr: "Lumière d'Élune supprime les étourdissements, les silences et les ralentissements.", en: 'Light of Elune removes Stuns, Silences, and Slows from its target.' },
            demoYoutubeId: null
          },
          {
            level: 20,
            name: { fr: 'Courroux céleste', en: 'Celestial Wrath' },
            icon: 'https://static.icy-veins.com/images/heroes/icons/large/storm_ui_icon_tyrande_starfall.jpg',
            description: { fr: 'Météores applique Marque du chasseur et ralentit davantage.', en: "Starfall applies Hunter's Mark and increases its Slow." },
            demoYoutubeId: null
          }
        ]
      },
      {
        enabled: false,
        order: 2,
        label: { fr: 'Build soin', en: 'Healing Build' },
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Ranger', en: 'Ranger' },
            icon: '',
            description: { fr: 'Améliore W.', en: 'Improves Sentinel.' },
            demoYoutubeId: null
          }
        ]
      }
  ...
  },
  {
    ...
    spells: [
      {
        key: 'Trait',
        name: { fr: "Dévotion d'avant-garde", en: 'Vanguard' },
        icon: '',
        description: { fr: "Les soins d'Uther donnent de l'armure. S'il meurt, il soigne en fantôme.", en: "Uther's heals grant armor. If he dies, he heals as a ghost." },
        demoYoutubeId: ''
      },
      {
        key: 'A',
        name: { fr: 'Lumière sacrée', en: 'Holy Light' },
        icon: '',
        description: { fr: 'Soin monocible massif.', en: 'Massive single-target heal.' },
        demoYoutubeId: ''
      },
      {
        key: 'Z',
        name: { fr: 'Radiance sacrée', en: 'Holy Radiance' },
        icon: '',
        description: { fr: 'Vague qui soigne les alliés et blesse les ennemis.', en: 'Wave that heals allies and damages enemies.' },
        demoYoutubeId: ''
      },
      {
        key: 'E',
        name: { fr: 'Marteau de la justice', en: 'Hammer of Justice' },
        icon: '',
        description: { fr: 'Étourdit un ennemi au corps-à-corps.', en: 'Stuns an enemy in melee range.' },
        demoYoutubeId: ''
      },
      {
        key: 'R1',
        name: { fr: 'Bouclier divin', en: 'Divine Shield' },
        icon: '',
        description: { fr: 'Rend un allié invulnérable.', en: 'Makes an ally Invulnerable.' },
        demoYoutubeId: ''
      },
      {
        key: 'R2',
        name: { fr: 'Tempête divine', en: 'Divine Storm' },
        icon: '',
        description: { fr: 'Étourdit tous les ennemis en zone.', en: 'Stuns all enemies in an area.' },
        demoYoutubeId: ''
      }
    ],
    tips: [
    ...
    builds: [
      {
        ...
        talents: [
          {
            level: 1,
            name: { fr: 'Choc sacré', en: 'Holy Shock' },
            icon: '',
            description: { fr: 'Permet au Q de faire des dégâts.', en: 'Allows Q to deal damage.' },
            demoYoutubeId: null
          }
        ]
      },
      {
        enabled: true,
        order: 2,
        label: { fr: 'Build Tank', en: 'Tank Build' },
  ...
  },
  {
    ...
    tips: [
      { fr: 'Gère ton mana, ne spamme pas le A.', en: 'Manage your Mana, do not spam Desperate Plea.' },
      { fr: 'Égide écarlate est parfait pour contrer les engages ennemis ou appliqué Zèle en masse.', en: 'Scarlet Aegis is perfect to counter enemy engages or to apply Zeal to multiple allies.' },
      { fr: 'Utilise Mansuétude entre deux A pour consommer le moins de mana possible.', en: 'Use Clemency between Desperate Plea casts to minimize Mana consumption.' }
    ],
    builds: [
      {
        enabled: true,
      ...
      },
      {
        enabled: false,
        order: 2,
        label: { fr: 'Build Pitié (Q)', en: 'Plea (Q) Build' },
        ...
        talents: [
          {
            ...
            name: { fr: 'Martyre', en: 'Martyrdom' },
            icon: '',
            description: { fr: 'Améliore Q.', en: 'Improves Q.' },
            demoYoutubeId: null
          }
        ]
      }
  ...
  },
  {
    ...
    spells: [
      {
        key: 'Trait',
        name: { fr: 'En construction.', en: 'Under construction.' },
        icon: '',
        description: { fr: 'En construction.', en: 'Under construction.' },
    ...
    builds: [
      {
        ...
        buildCode: '',
        videos: [
          { title: { fr: 'Combo 1', en: 'Combo 1' }, youtubeId: 'M7lc1UVf-VE', desc: { fr: 'En construction.', en: 'Under construction.' } },
          { title: { fr: 'Combo 2', en: 'Combo 2' }, youtubeId: 'ysz5S6PUM-U', desc: { fr: 'En construction.', en: 'Under construction.' } },
          { title: { fr: 'Combo 3', en: 'Combo 3' }, youtubeId: 'ScMzIvxBSi4', desc: { fr: 'En construction.', en: 'Under construction.' } },
          { title: { fr: 'Combo 4', en: 'Combo 4' }, youtubeId: 'aqz-KE-bpKQ', desc: { fr: 'En construction.', en: 'Under construction.' } }
        ],
        talents: [
          {
            level: 1,
